...
fn encode_data(data: Vec<u32>) -> Vec<u8> {
    ...
    for i in 0..data.len() {
        outdata.write_all(&data[i].to_le_bytes()).unwrap();
    }
    outdata
}
...
pub fn decode_r16(data: &mut Bytes, width: usize, height: usize) -> Vec<u8> {
    ...
    for i in 0..(width * height) {
        out.write_all(&[
            (((((data[i * 2 + 1] as u32) << 8) | (data[i * 2] as u32)) * 255 + 32895) >> 16) as u8,
            0,
            0,
            0xff
        ]).unwrap()
...
pub fn decode_rg32(data: &mut Bytes, width: usize, height: usize) -> Vec<u8> {
    ...
    for i in 0..(width * height) {
        out.write_all(&[
            (((((data[i * 4 + 1] as u32) << 8) | (data[i * 4] as u32)) * 255 + 32895) >> 16) as u8,
            (((((data[i * 4 + 3] as u32) << 8) | (data[i * 4 + 2] as u32)) * 255 + 32895) >> 16) as u8,
            0,
            0xff
        ]).expect("rg32");
    }
...
pub fn decode_rgb48(data: &mut Bytes, width: usize, height: usize) -> Vec<u8> {
    ...
    for i in 0..(width * height) {
        out.write_all(&[
            (((((data[i * 6 + 1] as u32) << 8) | (data[i * 6] as u32)) * 255 + 32895) >> 16) as u8,
            (((((data[i * 6 + 3] as u32) << 8) | (data[i * 6 + 2] as u32)) * 255 + 32895) >> 16) as u8,
            (((((data[i * 6 + 5] as u32) << 8) | (data[i * 6 + 4] as u32)) * 255 + 32895) >> 16) as u8,
            0xff
        ]).expect("r16");
    }
    out
...
pub fn decode_rgba64(data: &mut Bytes, width: usize, height: usize) -> Vec<u8> {
    ...
    for i in 0..(width * height) {
        out.write_all(&[
            (((((data[i * 8 + 1] as u32) << 8) | (data[i * 8] as u32)) * 255 + 32895) >> 16) as u8,
            (((((data[i * 8 + 3] as u32) << 8) | (data[i * 8 + 2] as u32)) * 255 + 32895) >> 16) as u8,
            (((((data[i * 8 + 5] as u32) << 8) | (data[i * 8 + 4] as u32)) * 255 + 32895) >> 16) as u8,
            (((((data[i * 8 + 7] as u32) << 8) | (data[i * 8 + 6] as u32)) * 255 + 32895) >> 16) as u8,
        ]).unwrap()
    }
    out
}
...
pub fn decode(format: TextureFormat, data: &mut Bytes, width: usize, height: usize, _is_xbox: bool) -> Vec<u8> {
    ...
    match format {
        ...
        TextureFormat::RGBA32 => data.to_vec(),
