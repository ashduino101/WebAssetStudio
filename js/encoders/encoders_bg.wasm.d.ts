...
export function wasm_bindgen__convert__closures__invoke1_mut__ha67cec4f97172d35(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke3_mut__h1f07c5bc0432675a(a: number, b: number, c: number, d: number, e: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h853fa16b698d2f84(a: number, b: number, c: number, d: number): void;
