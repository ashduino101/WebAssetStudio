...
export function decode_rgba5551(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function decode_rgbhalf(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function decode_rgbfloat(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function decode_l8(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function decode_la16(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function wasm_bindgen__convert__closures__invoke1_mut__hb3b14bbe2b043400(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke3_mut__h149c20f859398b12(a: number, b: number, c: number, d: number, e: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hb8c30effe9a1fd5f(a: number, b: number, c: number, d: number): void;
